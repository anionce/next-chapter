...
const es: Dict = {
  ...
  "result.scoreExplain": "Se recalcula cada día: cruza tu mood, la fecha y tu biblioteca — no es una nota fija.",
  "result.why": "Por qué este y no otro",
  "result.readThis": "Lee este.",
  "result.addWishlist": "Añadir a mi wishlist",
  "result.notToday": "Hoy no",
  "result.otherOptions": "Otras opciones para hoy",
...
const en: Dict = {
  ...
  "home.mood.desc": "Combine up to 3 feelings — cozy, atmospheric, tragic…",
  "home.mood.tag": "Most accurate",
  ...
  "mood.subtitle": ((total: number) =>
    `Combine up to 3. That's how we find the exact overlap — not another list of ${total} books.`) as Value,
  ...
  "result.new": "New, you don't have this",
  "result.newTag": "New",
  "result.searching": "Finding your next read…",
  "result.empty": "Nothing fits, in your library or outside it. Try a different mood.",
  "result.scoreExplain": "Recalculated every day: it crosses your mood, the date, and your library — not a fixed score.",
  ...
  "filters.pages": "Pages",
  "filters.pagesMin": "Min.",
  "filters.pagesMax": "Max.",
  "filters.years": "Published between",
  "filters.yearFrom": "From",
  "filters.yearTo": "To",
  "filters.pace": "Pace",
  "filters.paceAny": "Any",
  "filters.paceFast": "Fast-paced",
  "filters.paceSlow": "Slow-paced",
  ...
  "library.readingTitle": "Reading now",
  "library.readingEmpty": "Nothing in progress.",
